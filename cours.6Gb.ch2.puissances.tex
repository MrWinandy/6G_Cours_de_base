...
\begin{enumerate}[label=$\bullet$]
  ...
  \item $ \left(a^n\right)^p = a^{n\cdot p}$ \highlight{wegloossen op CB}
  \item $ a^{n}\cdot b^n  = \left(a\cdot b\right)^n $\highlight{wegloossen op CB}
...
\addexoInline{Écrire, si possible sous forme d'une seule puissance. Sinon, justifier.
	\begin{multicols}{2}\vspace{-\baselineskip}
		\begin{enumerate}
			...
			\item $ 8^5 : 8^2= $
			\item $ \dfrac{12^6}{12^4}= $
			\item $ \dfrac{3^9}{3^7}= $ %hei ass adaptéiert
			\item $ \dfrac{2^5}{8}= $
		\end{enumerate}
	\end{multicols}
}{-}
...
\addexoInline{
	Le son se propage environ a $ 3,4 \cdot  10^4  $ cm/s dans l'air. Quelle distance parcourt-il en uneminute quarante secondes ?
}{-}

\addexoInline{
	Un orage éclate a 3 km.
	\begin{enumerate}
		\item Sachant que la foudre se déplace à la vitesse de la lumière, c'est-à-dire $ 3 \cdot  10^5 $ km/s, combien de temps s'écoule-t-il avant de voir I'éclair ?
		\item Sachant que le bruit du tonnerre se déplace à la vitesse du son, c'est-a-dire 340 m/s, combien de temps s'écoule-t-il avant d'entendre le tonnerre ?
	\end{enumerate}
}{-}
